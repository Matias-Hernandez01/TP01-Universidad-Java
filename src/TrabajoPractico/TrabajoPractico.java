...
public class TrabajoPractico {
    ...
    public static void menuDos (String caso, String capacidadString, int capacidadEnMB) {
    	...
    	if(opcionMenu2 == 1) {
    		...
    		calcularBackUp(1, caso, capacidadEnMB);
    	}
    	if(opcionMenu2 == 2) {
    		System.out.println("Para el HDD: " + caso);
    		System.out.println("Con la capacidad: " + capacidadString);
    		calcularBackUp(2, caso, capacidadEnMB);
    	}
    	if(opcionMenu2 == 3) {
    		System.out.println("Para el HDD: " + caso);
    		System.out.println("Con la capacidad: " + capacidadString);
    		calcularBackUp(3, caso, capacidadEnMB);
    	}
    }
    
    public static void calcularBackUp (int elementBackUp, String disco, int capacidadEnMb) {
